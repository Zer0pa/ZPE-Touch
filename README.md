...
<sub>02 · ZPE Touch animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>02 · MARKETS</b><span>ADJACENT R&amp;D DOMAINS</span></div>
      <div>
        <div>
          <div><span>Haptics R&amp;D teams</span><span></span><span>best-fit</span></div>
          <div><span>Tactile-sensing labs</span><span></span><span>workflow</span></div>
          <div><span>Robot-skin sensing R&amp;D</span><span></span><span>candidate</span></div>
          <div><span>Teleoperation + embodied-interaction R&amp;D</span><span></span><span>research</span></div>
          <div><span>XR haptics experimenters</span><span></span><span>conditional</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b><span>DECLARED FIXTURES</span></div>
      <div>
        ...
        <div>
          <div><span>V_01 PASS</span><span></span><span>PASS</span></div>
          <div><span>V_02 PASS</span><span></span><span>PASS</span></div>
          <div><span>V_03 PASS</span><span></span><span>PASS</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE · BRANCH EXACT RATES</b></div>
      <div>
        <div>
          <div><span>Contact stream</span><span></span><span>1.0 exact</span></div>
          <div><span>Thermal stream</span><span></span><span>1.0 exact</span></div>
          <div><span>Vibrotactile stream</span><span></span><span>1.0 exact</span></div>
          <div><span>Proprioceptive stream</span><span></span><span>1.0 exact</span></div>
        </div>
      </div>
